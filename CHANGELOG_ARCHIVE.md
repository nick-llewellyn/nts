...
Historical release notes for `1.4.0` and earlier. Entries for `2.0.0`
and later live in [CHANGELOG.md](CHANGELOG.md).
...
combined history had grown past 220 KB. Consumers arriving from a
`1.x` release can read the migration notes here in the repository.
